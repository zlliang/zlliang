...
However, nightly master builds quietly stopped on November 26th, 2025, when the Zig team announced [the migration from GitHub to Codeberg](https://ziglang.org/news/migrating-from-github-to-codeberg/). I assumed the builds were provided by some automation tied to GitHub.
