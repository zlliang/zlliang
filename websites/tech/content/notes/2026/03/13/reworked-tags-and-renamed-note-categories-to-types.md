...
At the same time, I renamed the note `category` field to `type` for both websites. The canonical page is now [/notes/types](/notes/types), alongside [/notes/tags](/notes/tags). This is a small breaking change, but I think the new naming is clearer.
