...
Order and shape of an English review.
...
- Call out cases where the author's original is already stronger than the rewrite.

Example:

> Before: `In order to make the application run faster, we need to do optimization for the database queries.`
>
> After: `To speed up the application, we need to optimize the database queries.`
>
